...
app.post("/", function(req, res) {
  ...
  var cylinderHeight = parseFloat(req.body.n2);

  //computes the volume of cyclinder
  var volume = Math.PI * Math.pow(radCircle, 2) * cylinderHeight;


  // sends the results back to the web page as string
  res.send("The Area of the Circle: " + areaCircle.toFixed(2) + " Circumference: " + circumCircle.toFixed(2) + " Volume: " + volume.toFixed(2));
});
